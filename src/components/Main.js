              ...
              props.articles.map((article, key) => (
                <Article key={key}>
                  ...
                  <SocialCounts>
                    ...
                    <li>
                      <a href="">{article.comments === 0 ? 0 : article.comments} comments</a>
                    </li>
                  </SocialCounts>
  ...
  a {
    ...
    & > div {
      ...
      span {
        ...
        /* n+1 adalah setelah value first-child yaitu 2 atau value terakhir maka ditambah 1 .. itulah yang diambil*/
        &:nth-child(n + 1) {
          font-size: 12px;
          color: rgba(0, 0, 0, 0.6);
        }
